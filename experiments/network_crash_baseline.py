...
def execute(groundstations: List[AbstractGroundstation], satellites: List[AbstractSatellite], _cloud, flow_record,
	...
	execute_logger.setLevel(logging.DEBUG)
...
if __name__ == '__main__':
	...
	parser.add_argument('--result_dir', type=str, default='data/network_crash_baseline/')
	parser.add_argument('--log_file', type=str, default='log/network_crash_baseline.log')
